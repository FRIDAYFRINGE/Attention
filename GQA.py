...
#  24 and 4 then heads per gp -> 6
    ...
    def forward(self,x):
        ...
        # now repeat or map KV so each head get KV (Q- 12 heads, KV - 4 heads , if gps is 3 heads)
        # maping -> Map each head index to its group index (e.g. [0,0,0,1,1,1,2,2,2,3,3,3])
        device = x.device
        ...
        #let's do attn socre, weights, value weights, output 
